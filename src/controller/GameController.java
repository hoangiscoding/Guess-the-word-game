...
public class GameController {
    ...
    public IntegerProperty rubyProperty;
    ...
    @FXML
    private void muteBtnClicked() {
        isMuted = !isMuted;

        SoundMaker.setMute(isMuted);
    ...
    private void setupLevel() {
        ...
        levelProperty.setValue("Màn " + (currentLevel+1));
    ...
    public void hintBtnClicked() {
        if (ruby-5 >= 0 && !textFieldHolder.allFilled()) {
            ...
            SoundMaker.wrong();
            MessageBox.show("Các ô chữ đã full", "Thông báo", stage);
        }
        else {
            SoundMaker.wrong();
            MessageBox.show("Không đủ Ruby", "Thông báo", stage);
        }
    }

    private void setupGameOverScene() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/gui/gameOver.fxml"));
